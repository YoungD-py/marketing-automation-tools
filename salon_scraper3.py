...
# === PENGATURAN ===
KATA_KUNCI = "SALON TOMOHON"  # Ganti sesuai kebutuhan
...
with open("hasil_salon_TOMOHON.txt", "w", encoding="utf-8") as f:
    for nomor in hasil:
        f.write(nomor + "\n")

print(f"\n✅ Selesai! {len(hasil)} nomor telepon unik tersimpan di hasil_salon_TOMOHON.txt")